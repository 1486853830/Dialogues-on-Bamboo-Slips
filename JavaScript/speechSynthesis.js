...
const characterTTSParams = {
    "曹操":     { voice_type: "longshu", rate: 0.9, pitch: 0.95, volume: 60 },
    "樊哙":     { voice_type: "longshu", rate: 1.0, pitch: 0.9, volume: 60 },
    "霍去病":   { voice_type: "longcheng", rate: 1.0, pitch: 1.0, volume: 60 },
    "锦衣卫":   { voice_type: "longfei", rate: 1.0, pitch: 1.0, volume: 60 },
    "孔子":     { voice_type: "longshu", rate: 1.0, pitch: 0.9, volume: 60 },
    "令狐冲":   { voice_type: "longfei", rate: 0.9, pitch: 1.0, volume: 60 },
    "刘邦":     { voice_type: "longfei", rate: 1.0, pitch: 0.95, volume: 60 },
    "刘备":     { voice_type: "longfei", rate: 1.0, pitch: 0.95, volume: 60 },
    "孟德尔":   { voice_type: "longfei", rate: 1.0, pitch: 1.0, volume: 60 },
    "牛顿":     { voice_type: "loogfei", rate: 1.0, pitch: 1.0, volume: 60 },
    "丘处机":   { voice_type: "longfei", rate: 1.0, pitch: 1.0, volume: 60 },
    "司马光":   { voice_type: "longshu", rate: 1.0, pitch: 1.0, volume: 60 },
    "松赞干布": { voice_type: "longyuan", rate: 1.0, pitch: 1.0, volume: 60 },
    "孙权":     { voice_type: "longfei", rate: 1.0, pitch: 1.0, volume: 60 },
    "腾格里骑兵": { voice_type: "longfei", rate: 1.0, pitch: 0.95, volume: 60 },
    "铁木真":   { voice_type: "longfei", rate: 1.0, pitch: 1.0, volume: 60 },
    "王安石":   { voice_type: "longfei", rate: 1.0, pitch: 1.0, volume: 60 },
    "文成公主": { voice_type: "longmiao", rate: 1.0, pitch: 1.0, volume: 60 },
    "项羽":     { voice_type: "longfei", rate: 1.0, pitch: 1.0, volume: 60 },
    "耶律阿保机": { voice_type: "longfei", rate: 1.0, pitch: 0.95, volume: 60 },
    "嬴政":     { voice_type: "longfei", rate: 0.9, pitch: 0.95, volume: 60 },
    "岳飞":     { voice_type: "longfei", rate: 1.0, pitch: 1.0, volume: 60 },
    "斩锋卒":   { voice_type: "longfei", rate: 1.0, pitch: 1.0, volume: 60 },
    "张飞":     { voice_type: "longlaotie", rate: 1.0, pitch: 0.9, volume: 60 },
    "张居正":   { voice_type: "longfei", rate: 1.0, pitch: 1.0, volume: 60 },
    "张良":     { voice_type: "longcheng", rate: 1.0, pitch: 1.0, volume: 60 },
    "张骞":     { voice_type: "longfei", rate: 1.0, pitch: 0.95, volume: 60 },
    "赵云":     { voice_type: "longcheng", rate: 1.0, pitch: 1.0, volume: 60 },
    "朱翊钧":   { voice_type: "longcheng", rate: 1.0, pitch: 1.0, volume: 60 },
